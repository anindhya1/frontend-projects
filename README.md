...
### 1. Acme Dashboard — `nextjs_project/nextjs-dashboard/`
...
### 2. JavaScript Amazon Clone — `javascript-amazon-project/`
...
### 3. React Chatbot — `react-projects/chatbot-project/`
...
### 4. React Ecommerce — `react-projects/ecomerce-project/`
